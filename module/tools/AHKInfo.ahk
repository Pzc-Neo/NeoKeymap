...
;			创建窗口控件
;===============================================
Gui, 1:Add, GroupBox, x10 y5 w232 h40 , 窗口信息
Gui, 1:Add, Text, x17 y22 w42 h19 , 标题:
Gui, 1:Add, Edit, x55 y19 w180 h19 ReadOnly -Wrap  vTitle
Gui, 1:Add, Picture, x252 y10 w32 h32 gSetico vPic
Gui, 1:Add, Tab2,+Theme -Background -Wrap AltSubmit gTab_Click x6 y50 w337 h358  vTab1,窗口|控件|V/A文本|样式表|操作|IE元素|IE操作
;==========================================================
Gui, 1:Tab, 1  ;以下创建的控件属于第一个标签页
Gui, 1:Add, ListView,NoSort Grid NoSortHdr -Multi gListView_DoubleClick vListView1  x8 y75 w%控件宽% h306 , 属性|值
...
Gui, 1:Add, ListView,NoSort Grid NoSortHdr -Multi gListView_DoubleClick vListView2 x8 y75 w%控件宽% h158 , 属性|值
...
LV_ModifyCol(2, 256)
;......................
Gui, 1:Add, ListView,AltSubmit Checked Grid NoSort -Multi HwndLV4H gListView_DoubleClick vListView4 x8 y233 w%控件宽% h170 ,控件列表|ID|句柄|文本|
;==========================================================
Gui, 1:Tab, 3 ;以下创建的控件属于第3个标签页 []
Gui, 1:Add, Edit,HScroll ReadOnly x8 y75 w%控件宽% h162 vVisible_text,这里将显示的是可见文本
Gui, 1:Add, Edit,HScroll ReadOnly x8 y237 w%控件宽% h162 vHidden_text,这里将显示的是全部文本
;==========================================================
Gui, 1:Tab, 4 ;以下创建的控件属于第4个标签页
;~ Gui, 1:Add, GroupBox, x5 y310 w266 h90 , 全局鼠标
;~ ;全局鼠标列表
Gui, 1:Add, ListView,HwndLV3H NoSort NoSortHdr AltSubmit Checked Grid -Multi gListView_DoubleClick vListView3 x8 y75 w%控件宽% h325 , 窗口样式|值|说明
...
Gui, Add, Text, x13 y77,窗口识别条件:
Gui, Add, Checkbox,Checked x95 y74 h18 w45  vCheckbox1,标题
Gui, Add, Checkbox,Checked x145 y74 h18 vCheckbox2,类
Gui, Add, Checkbox, x185 y74 w57 h18 vCheckbox3,进程名
Gui, Add, Checkbox, x245 y74 w46 h18 vCheckbox4,Text
Gui, Add, Button,x295 y73 w35 h20 gbutton1,生成
Gui, 1:Add, Edit, HScroll ReadOnly x8 y95 w%控件宽% h305 vGenerate_text
;==========================================================
Gui, 1:Tab, 6 ;以下创建的控件属于第6个标签页 IE元素
Gui, 1:Add, ListView,AltSubmit NoSort NoSortHdr Grid -Multi HwndLV5H gListView_DoubleClick vListView5  x8 y75 w%控件宽% h238 , 元素属性|属性值
...
Gui, 1:Add, Edit,ReadOnly x8 y326 w%控件宽% h75 vEdit1
Radio1Text:=
Radio2Text:=
;==========================================================
...
Gui, 1:Add, Edit, HScroll ReadOnly x8 y95 w%控件宽% h305 vIeGenerate_text
global Radio3_Text:=
global Radio4_Text:=
...
Y:=_RegR("Y")="" ? 0:_RegR("Y")
;~ MsgBox,%X%
Gui, 1:Show,x %X% y %Y% w%窗口宽% h410, %AHKInfo_Title%
;=====================================================
Gui, 2:Color,FF0000
